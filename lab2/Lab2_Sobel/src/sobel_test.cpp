...
int main () {
  ...
  ifstream file("G:\fpga_design\fpga_learning\fpga_summer_camp\res\Lab2_Sobel\src\data.txt");
  string line;
  short int s1;
  int i = 0;
...
//verify the result
  ifstream fileo("G:\fpga_design\fpga_learning\fpga_summer_camp\res\Lab2_Sobel\src\dst_1280x720.txt");
  string lineo;
  short int s2;
  int j = 0;
  int err_cnt = 0;
...
//  write the result to txt
    ofstream fout;
    fout.open("G:\fpga_design\fpga_learning\fpga_summer_camp\res\Lab2_Sobel\src\imgo.txt");
    int m = 0;
    string pixelo;
    short int pixel;
