        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_coef_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    if(image_mem_coef[write_coef_count * four_byte_num  + i]!==coef_data_tmp_reg) begin
                    write (coef_data_in_addr + write_coef_count * ceil_align_to_pow_of_two_four_byte_num * 4 + i * 4, coef_data_tmp_reg, write_coef_resp);
                    image_mem_coef[write_coef_count * four_byte_num + i]=coef_data_tmp_reg;
                    end
                end
                process_busy = 0;
